...
struct ModelPart
{
	...
	ModelPart() : material(), texDiffuse(), texArray(),vertexBuffer(), indexBuffer(),
		vertexCount(), indexCount(), indexFormat(),TexIndex_n_xyz(0,0,0,0),TexIndex_p_xyz(0,0,0,0) {}
	...
	ComPtr<ID3D11ShaderResourceView> texArray;
	ComPtr<ID3D11Buffer> vertexBuffer;
	ComPtr<ID3D11Buffer> indexBuffer;
	UINT vertexCount;
	UINT indexCount;
	DXGI_FORMAT indexFormat;
	DirectX::XMFLOAT4 TexIndex_p_xyz;
	DirectX::XMFLOAT4 TexIndex_n_xyz;
};
